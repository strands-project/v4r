                                                         ...
                                                         std::vector<std::vector<float> > > input)
{
    ...
    return process(pointClouds, normals, weights);
...
std::vector<Eigen::Matrix4f> GlobalRegistration::process(std::vector<pcl::PointCloud<pcl::PointXYZRGB>::Ptr> & pointClouds,
