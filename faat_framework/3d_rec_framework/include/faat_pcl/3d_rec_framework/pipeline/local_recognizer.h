    ...
    template<template<class > class Distance, typename PointInT, typename FeatureT>
      class FAAT_3D_FRAMEWORK_API LocalRecognitionPipeline : public Recognizer<PointInT>
      {
        protected:
          ...
          typename boost::shared_ptr<pcl::CorrespondenceGrouping<PointInT, PointInT> > cg_algorithm_;
      ...
      public:
         ...
         */
        void
        setCGAlgorithm (typename boost::shared_ptr<pcl::CorrespondenceGrouping<PointInT, PointInT> > & alg)
        {
          cg_algorithm_ = alg;
        }
