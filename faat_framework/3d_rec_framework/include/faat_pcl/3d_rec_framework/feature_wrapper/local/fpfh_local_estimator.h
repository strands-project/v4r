...
#ifndef FAAT_PCL_REC_FRAMEWORK_FPFH_LOCAL_ESTIMATOR_H_
#define FAAT_PCL_REC_FRAMEWORK_FPFH_LOCAL_ESTIMATOR_H_
...
namespace faat_pcl
{
  namespace rec_3d_framework
  {
    template<typename PointInT, typename FeatureT>
      class FAAT_3D_FRAMEWORK_API FPFHLocalEstimation : public LocalEstimator<PointInT, FeatureT>
      {
