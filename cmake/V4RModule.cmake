...
macro(v4r_module_include_directories)
  ...
  v4r_target_include_modules(${the_module} ${V4R_MODULE_${the_module}_DEPS} ${ARGN})
endmacro()
...
macro(_v4r_create_module)
  ...
  v4r_target_link_libraries(${the_module} ${V4R_MODULE_${the_module}_DEPS_EXT} ${V4R_LINKER_LIBS} ${IPP_LIBS} ${ARGN})
  if (HAVE_CUDA)
