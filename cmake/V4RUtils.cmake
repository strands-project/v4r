...
function(v4r_target_include_directories target)
  ...
  foreach(dir ${ARGN})
    get_filename_component(__abs_dir "${dir}" ABSOLUTE)
    if("${__abs_dir}" MATCHES "^${V4R_SOURCE_DIR}" OR "${__abs_dir}" MATCHES "^${V4R_BINARY_DIR}")
      list(APPEND __params_before "${__abs_dir}")
    else()
      list(APPEND __params_after "${dir}")
    endif()
  endforeach()
  if(HAVE_CUDA OR CMAKE_VERSION VERSION_LESS 2.8.11)
    include_directories(${__params_before})#(simon) add include directories as system directories.... this suppresses warnings
    include_directories(SYSTEM ${__params_after})
  else()
    if(TARGET ${target})
      target_include_directories(${target} SYSTEM ${__params_before})
      target_include_directories(${target} SYSTEM PRIVATE ${__params_after})#(simon) suppress warnings
    else()
      set(__new_inc "${V4R_TARGET_INCLUDE_DIRS_${target}};${__params_before};${__params_after")
