...
set(CMAKE_MODULE_PATH "${V4R_SOURCE_DIR}/cmake" ${CMAKE_MODULE_PATH})
...
if(CUDA_FOUND)
  ...
  elseif(CUDA_GENERATION STREQUAL "Auto")
    execute_process( COMMAND "${CUDA_NVCC_EXECUTABLE}" "${V4R_SOURCE_DIR}/cmake/checks/V4RDetectCudaArch.cu" "--run"
  ...
  set(V4R_CUDA_ARCH_BIN "")
  set(V4R_CUDA_ARCH_PTX "")
  set(V4R_CUDA_ARCH_FEATURES "")
  ...
  foreach(ARCH IN LISTS ARCH_LIST)
    if(ARCH MATCHES "([0-9]+)\\(([0-9]+)\\)")
      ...
      set(V4R_CUDA_ARCH_BIN "${V4R_CUDA_ARCH_BIN} ${CMAKE_MATCH_1}")
      set(V4R_CUDA_ARCH_FEATURES "${V4R_CUDA_ARCH_FEATURES} ${CMAKE_MATCH_2}")
    else()
      # User didn't explicitly specify PTX for the concrete BIN, we assume PTX=BIN
      set(NVCC_FLAGS_EXTRA ${NVCC_FLAGS_EXTRA} -gencode arch=compute_${ARCH},code=sm_${ARCH})
      set(V4R_CUDA_ARCH_BIN "${V4R_CUDA_ARCH_BIN} ${ARCH}")
      set(V4R_CUDA_ARCH_FEATURES "${V4R_CUDA_ARCH_FEATURES} ${ARCH}")
    endif()
  endforeach()
  ...
  foreach(ARCH IN LISTS ARCH_LIST)
    ...
    set(V4R_CUDA_ARCH_PTX "${V4R_CUDA_ARCH_PTX} ${ARCH}")
    set(V4R_CUDA_ARCH_FEATURES "${V4R_CUDA_ARCH_FEATURES} ${ARCH}")
  endforeach()

  # These vars will be processed in other scripts
  set(CUDA_NVCC_FLAGS ${CUDA_NVCC_FLAGS} ${NVCC_FLAGS_EXTRA})
  set(V4R_CUDA_CC "${NVCC_FLAGS_EXTRA}")
