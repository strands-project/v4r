...
int main(int argc, char** argv)
{
  ...
  switch(type)
  {
    ...
    case(2):
      printf("SHORT MAP \n");
      surfaceHeightSaliencyMap.setHeightType(v4r::AM_SHORT);
      break;
    default:
  ...
  switch(combination_type)
  {
    case(0):
      printf("SUM \n");
      surfaceHeightSaliencyMap.setCombinationType(v4r::AM_COMB_SUM);
      break;
    case(1):
      printf("MUL \n");
      surfaceHeightSaliencyMap.setCombinationType(v4r::AM_COMB_MUL);
      break;
    case(2):
      printf("MAX \n");
      surfaceHeightSaliencyMap.setCombinationType(v4r::AM_COMB_MAX);
      break;
    default:
      printf("UNDEFINED -- return \n");
      return(0);
  ...
  switch(pyramid_type)
  {
    ...
    case(1):
      printf("SIMPLE \n");
      surfaceHeightSaliencyMap.calculatePyramid(v4r::SIMPLE_PYRAMID);
      break;
    case(2):
      printf("ITTI \n");
      surfaceHeightSaliencyMap.calculatePyramid(v4r::ITTI_PYRAMID);
      break;
    case(3):
      printf("FRINTROP \n");
      surfaceHeightSaliencyMap.calculatePyramid(v4r::FRINTROP_PYRAMID);
      break;
    default:
      printf("UNDEFINED -- return \n");
      return(0);
