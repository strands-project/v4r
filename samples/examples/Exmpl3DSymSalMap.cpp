...
int main(int argc, char** argv)
{
  ...
  v4r::preparePointCloud(cloud,normals,object_indices_in_the_hull,true);

  // start creating parameters
  v4r::Symmetry3DMap symmetry3DMap;
  ...
  switch(combination_type)
  {
    case(0):
      printf("SUM \n");
      symmetry3DMap.setCombinationType(v4r::AM_COMB_SUM);
      break;
    case(1):
      printf("MUL \n");
      symmetry3DMap.setCombinationType(v4r::AM_COMB_MUL);
      break;
    case(2):
      printf("MAX \n");
      symmetry3DMap.setCombinationType(v4r::AM_COMB_MAX);
      break;
    default:
  ...
  switch(normalization_type)
  {
    case(0):
      printf("LIN \n");
      symmetry3DMap.setNormalizationType(v4r::NT_NONE);
      break;
    case(1):
      printf("NMS \n");
      symmetry3DMap.setNormalizationType(v4r::NT_NONMAX);
      break;
    case(2):
      printf("NLM \n");
      symmetry3DMap.setNormalizationType(v4r::NT_FRINTROP_NORM);
      break;
    default:
      printf("UNDEFINED -- return \n");
      return(0);
  ...
  switch(pyramid_type)
  {
    ...
    case(1):
      printf("SIMPLE \n");
      symmetry3DMap.calculatePyramid(v4r::SIMPLE_PYRAMID);
      break;
    case(2):
      printf("ITTI \n");
      symmetry3DMap.calculatePyramid(v4r::ITTI_PYRAMID);
      break;
    case(3):
      printf("FRINTROP \n");
      symmetry3DMap.calculatePyramid(v4r::FRINTROP_PYRAMID);
      break;
    default:
      printf("UNDEFINED -- return \n");
      return(0);
