...
int main(int argc, char** argv)
{
  ...
  v4r::OrientationSaliencyMap orientationSaliencyMap;
  ...
  orientationSaliencyMap.calculatePyramid(v4r::ITTI_PYRAMID);
  ...
  orientationSaliencyMap.calculatePyramid(v4r::FRINTROP_PYRAMID);
