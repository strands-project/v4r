...
int main(int argc, char** argv)
{
  ...
  v4r::preparePointCloud(cloud,coefficients,normals,object_indices_in_the_hull);
  ...
  switch(type)
  {
    ...
    case(1):
      printf("VERTICAL MAP \n");
      relativeSurfaceOrientationMap.setOrientationType(v4r::AM_VERTICAL);
      break;
    default:
  ...
  switch(combination_type)
  {
    case(0):
      printf("SUM \n");
      relativeSurfaceOrientationMap.setCombinationType(v4r::AM_COMB_SUM);
      break;
    case(1):
      printf("MUL \n");
      relativeSurfaceOrientationMap.setCombinationType(v4r::AM_COMB_MUL);
      break;
    case(2):
      printf("MAX \n");
      relativeSurfaceOrientationMap.setCombinationType(v4r::AM_COMB_MAX);
      break;
    default:
      printf("UNDEFINED -- return \n");
      return(0);
  ...
  switch(pyramid_type)
  {
    ...
    case(1):
      printf("SIMPLE \n");
      relativeSurfaceOrientationMap.calculatePyramid(v4r::SIMPLE_PYRAMID);
      break;
    case(2):
      printf("ITTI \n");
      relativeSurfaceOrientationMap.calculatePyramid(v4r::ITTI_PYRAMID);
      break;
    case(3):
      printf("FRINTROP \n");
      relativeSurfaceOrientationMap.calculatePyramid(v4r::FRINTROP_PYRAMID);
      break;
    default:
      printf("UNDEFINED -- return \n");
      return(0);
