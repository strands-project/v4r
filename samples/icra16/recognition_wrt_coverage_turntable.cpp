...
//                    v4r::io::copyDir(in_training_dir_ + "/" + model_name, out_tmp_training_dir_ + "/" + model_name);
            ...
            const std::string out_tmp_training_dir_replaced_model = out_tmp_ + "/training_data/" + replaced_model;
            ...
            for (size_t num_used_v = num_training_views-1; num_used_v > 0; num_used_v--)
            {
                ...
                for (size_t start_v = 0; start_v < num_training_views; start_v+=step_size_start_training_views_)
                {
                    ...
                    for (size_t v_id_rel=0; v_id_rel<num_used_v; v_id_rel++)
                    {
                        ...
                        bf::create_symlink(in_turntable_ + "/training_data/" + replaced_model + "/" + training_views[v_id], out_tmp_training_dir_replaced_model + "/" + training_views[v_id]);
                        bf::create_symlink(in_turntable_ + "/training_data/" + replaced_model + "/" + pose_fns[v_id], out_tmp_training_dir_replaced_model + "/" + pose_fns[v_id]);
                        bf::create_symlink(in_turntable_ + "/training_data/" + replaced_model + "/" + obj_indices_fns[v_id], out_tmp_training_dir_replaced_model + "/" + obj_indices_fns[v_id]);
                        bf::create_symlink(in_turntable_ + "/training_data/" + replaced_model + "/" + sift_descriptor_fns[v_id], out_tmp_training_dir_replaced_model + "/" + sift_descriptor_fns[v_id]);
                        bf::create_symlink(in_turntable_ + "/training_data/" + replaced_model + "/" + sift_keypoint_fns[v_id], out_tmp_training_dir_replaced_model + "/" + sift_keypoint_fns[v_id]);
                        bf::create_symlink(in_turntable_ + "/training_data/" + replaced_model + "/" + sift_keypoint_normal_fns[v_id], out_tmp_training_dir_replaced_model + "/" + sift_keypoint_normal_fns[v_id]);
                        bf::create_symlink(in_turntable_ + "/training_data/" + replaced_model + "/" + shot_descriptor_fns[v_id], out_tmp_training_dir_replaced_model + "/" + shot_descriptor_fns[v_id]);
                        bf::create_symlink(in_turntable_ + "/training_data/" + replaced_model + "/" + shot_keypoint_fns[v_id], out_tmp_training_dir_replaced_model + "/" + shot_keypoint_fns[v_id]);
                        bf::create_symlink(in_turntable_ + "/training_data/" + replaced_model + "/" + shot_keypoint_normal_fns[v_id], out_tmp_training_dir_replaced_model + "/" + shot_keypoint_normal_fns[v_id]);
                    }
                    ...
                    pcl::io::savePCDFileBinary(out_tmp_ + "/models/" + replaced_model, *octree_cloud);
