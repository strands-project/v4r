...
typedef struct V4R_EXPORTS PlyProperty {    /* description of a property */
...
typedef struct V4R_EXPORTS PlyElement {     /* description of an element */
...
typedef struct V4R_EXPORTS PlyOtherProp {   /* describes other properties in an element */
  char *name;                   /* element name */
...
typedef struct V4R_EXPORTS OtherData { /* for storing other_props for an other element */
  void *other_props;
} OtherData;

typedef struct V4R_EXPORTS OtherElem {     /* data for one "other" element */
...
typedef struct V4R_EXPORTS PlyOtherElems {  /* "other" elements, not interpreted by user */
  int num_elems;                /* number of other elements */
  OtherElem *other_list;        /* list of data for other elements */
} PlyOtherElems;

typedef struct V4R_EXPORTS PlyFile {        /* description of PLY file */
