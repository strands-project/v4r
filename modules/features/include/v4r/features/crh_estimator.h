...
namespace pcl
{
    ...
    class V4R_EXPORTS CRHEstimation : public GlobalEstimator<PointInT, FeatureT>
    {
    ...
    public:
      ...
      void
      setFeatureEstimator(const typename boost::shared_ptr<GlobalEstimator<PointInT, FeatureT> > & feature_estimator) {
