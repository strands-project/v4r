...
void GraphCut::setSurfaces(const std::vector<v4r::SurfaceModel::Ptr> _surfaces)
{
  surfaces = _surfaces;
  have_surfaces = true;
}

void GraphCut::setRelations(std::vector<v4r::Relation> _relations)
{
...
bool smallerRelations(const v4r::Relation &a, const v4r::Relation &b)
{
