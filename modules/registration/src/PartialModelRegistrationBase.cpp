...
v4r::Registration::PartialModelRegistrationBase<PointT>::getCloud(size_t i) const
{
...
template<class PointT>
std::vector<int> &
v4r::Registration::PartialModelRegistrationBase<PointT>::getIndices(size_t i) const
{
...
template<class PointT>
Eigen::Matrix4f
v4r::Registration::PartialModelRegistrationBase<PointT>::getPose(size_t i) const
{
...
v4r::Registration::PartialModelRegistrationBase<PointT>::getNormal(size_t i) const
{
