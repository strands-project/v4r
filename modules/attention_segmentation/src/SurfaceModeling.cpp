...
//     exit(0);
  ...
  std::sort(mergePairs.begin(),mergePairs.end(),v4r::cmpSavings);
...
//   v4r::get2DNeighbors(patches,neighbors2D,nr_patches);
//   v4r::get3DNeighbors<pcl::PointXYZRGB>(patches,neighbors3D,nr_patches,cloud,param.z_max);
//   
