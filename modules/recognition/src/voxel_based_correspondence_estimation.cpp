...
//template class VoxelBasedCorrespondenceEstimation<pcl::PointXYZ, pcl::PointXYZ >;
//template class VoxelBasedCorrespondenceEstimation<pcl::PointXYZRGB, pcl::PointXYZRGB >;
//template class VoxelBasedCorrespondenceEstimation<pcl::PointXYZRGBA, pcl::PointXYZRGBA >;
}
