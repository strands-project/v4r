...
//            ("visualize,v", po::bool_switch(&visualize_), "visualize recognition results")
            ...
            ("hv_w_occupied_multiple_cm", po::value<double>(&paramGO3D.w_occupied_multiple_cm_)->default_value(paramGO3D.w_occupied_multiple_cm_, boost::str(boost::format("%.2e") % paramGO3D.w_occupied_multiple_cm_) ), " ")
            ("hv_w_occupied_multiple", po::value<double>(&paramGO3D.w_occupied_multiple_)->default_value(paramGO3D.w_occupied_multiple_, boost::str(boost::format("%.2e") % paramGO3D.w_occupied_multiple_) ), " ")
