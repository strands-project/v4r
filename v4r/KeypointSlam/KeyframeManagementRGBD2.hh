...
#include "v4r/KeypointTools/RandomNumbers.hpp"
...
public:
  ...
  typedef SmartPtr< ::kp::KeyframeManagementRGBD2> Ptr;
  typedef SmartPtr< ::kp::KeyframeManagementRGBD2 const> ConstPtr;
};
