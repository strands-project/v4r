...
#ifndef KP_PROJ_LK_POSE_TRACKER_GL_LM_HH
#define KP_PROJ_LK_POSE_TRACKER_GL_LM_HH
...
#include "Object.hpp"
#include "v4r/KeypointBase/RefineProjectedPointLocationLKGPU.hh"
...
/**
 * ProjLKPoseTrackerLM_GL
 */
class ProjLKPoseTrackerLM_GL
{
public:
  class Parameter
  {
...
private:
  ...
  RefineProjectedPointLocationLKGPU::Ptr plk;
...
public:
  ...
  ProjLKPoseTrackerLM_GL(const Parameter &p=Parameter());
  ~ProjLKPoseTrackerLM_GL();
  ...
  typedef SmartPtr< ::kp::ProjLKPoseTrackerLM_GL> Ptr;
  typedef SmartPtr< ::kp::ProjLKPoseTrackerLM_GL const> ConstPtr;
};


/***************************** inline methods *******************************/

inline bool ProjLKPoseTrackerLM_GL::contains(const std::vector<int> &idx, int num)
{
