...
KeypointSlamRGBD2::KeypointSlamRGBD2(const KeypointSlamRGBD2::Parameter &p)
 : param(p), view_pose(Eigen::Matrix4f::Identity()), delta_pose(Eigen::Matrix4f::Identity()), conf(0.), conf_cnt(0), new_kf_1st_frame(-1), new_kf_2nd_frame(-1)
{ 
