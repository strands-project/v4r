...
#include <v4r/ORRecognition/geometric_consistency.hpp>
...
void v4r::Registration::nearestKSearch ( boost::shared_ptr< flann::Index<flann::L1<float> > > &index, float * descr, int descr_size, int k, flann::Matrix<int> &indices,
