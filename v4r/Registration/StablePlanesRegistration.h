    ...
    namespace Registration
    {
        ...
        class StablePlanesRegistration : public PartialModelRegistrationBase<PointT>
        {
            private:
                ...
                inline void
                getIndicesFromCloud(typename pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr & processed,
                                    typename pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr & keypoints_pointcloud,
                                    std::vector<int> & indices)
                {
                    pcl::octree::OctreePointCloudSearch<pcl::PointXYZRGBNormal> octree (0.005);
